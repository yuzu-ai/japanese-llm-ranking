...
python $EVAL_DIR/get_model_qa.py \
    ...
    --answer_file $EVAL_DIR/answers/rakuda_koukou_v0_rinna-gpt-neox-3.6b.jsonl \
    --load_8bit False \
    --max_new_tokens 256 \
    --repetition_penalty 1.1 > $OUTPUTS_DIR/rinna-gpt-neox-3.6b-max256.out 2> $OUTPUTS_DIR/rinna-gpt-neox-3.6b-max256.err
