...
class EloRanker:
    ...
    def add_to_matches(self, bot1, bot2, challenge):
        self.matches_to_run.append((bot1, bot2, challenge))
    ...
    def prepare_matches(self, num_matchups):
        ...
        for cached_result in cached_results:
            ...
            if not bot1 or not bot2 or not challenge:
                ...
                self.add_to_matches(bot1, bot2, challenge, self.verbose)
                matchup += 1
        ...
        def process_match(self, match):
            # Your match processing code here
            # This method should take a match from self.matches_to_run and process it 
