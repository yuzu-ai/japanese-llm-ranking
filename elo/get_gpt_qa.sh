...
python $EVAL_DIR/get_gpt_qa.py -q $EVAL_DIR/datasets/rakuda_koukou_v0.jsonl -o $EVAL_DIR/answers/rakuda_koukou_v0_gpt3.jsonl > $OUTPUT_DIR/qa_gpt.out 2> $OUTPUT_DIR/qa_gpt.err
