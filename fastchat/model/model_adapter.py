...
https://github.com/lm-sys/FastChat/blob/main/fastchat/model/model_adapter.py
"""
...
def load_model(
    ...
    if device == "cpu":
        ...
        pass
        ## SCP: Commenting this out since no intention for mac support at present
    ...
    if lora_path:
        print(f"Loading PEFT...", file=sys.stderr)
