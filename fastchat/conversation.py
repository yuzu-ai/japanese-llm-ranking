...
class SeparatorStyle(Enum):
    ...
    @staticmethod
    def from_string(style_str):
        """Return a SeparatorStyle given its name as a string."""
        try:
            return SeparatorStyle[style_str]
        except KeyError:
            raise ValueError(f'Invalid SeparatorStyle: {style_str}')
...
class Conversation:
    ...
    def from_json(cls, json_file):
        ...
        if 'sep_style' in config:
            config['sep_style'] = SeparatorStyle.from_string(config['sep_style'])
